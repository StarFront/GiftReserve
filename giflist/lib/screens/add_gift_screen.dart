...
class _AddGiftScreenState extends State<AddGiftScreen> {
  ...
  // Use the shared in-memory service instance
  ...
  void initState() {
    ...
    if (g != null) {
      ...
      _quantityController.text = g.quantity.toString();
      // image name stored in imageUrl previously
      _selectedImageName = g.imageUrl;
      _selectedImageBytes = g.imageData;
      _isReserved = g.isReserved;
      // bytes not available in this mock; left null
    }
  }
  ...
  Future<void> _pickImage() async {
    try {
      ...
      // ignore file picker errors for now
  ...
  Future<void> _handleAddGift() async {
    ...
    try {
      ...
      if (_nameController.text.isEmpty) {
        throw Exception('El nombre del regalo es requerido');
      }
      ...
      if (_quantityController.text.isEmpty) {
        throw Exception('La cantidad es requerida');
      }

      if (!_isValidQuantity(_quantityController.text)) {
        throw Exception('La cantidad debe ser un número entero válido');
      }
      ...
      // Persistir en el servicio en memoria (simula backend)
      ...
      print('Regalo guardado: ${gift.toJson()}');

      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('¡Regalo agregado exitosamente!'),
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              maxLines: 3,
              decoration: InputDecoration(
                hintText: 'Describe el regalo en detalle...',
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText: 'https://ejemplo.com/producto',
            ...
            // Botón Agregar Regalo
            ElevatedButton.icon(
              onPressed: _isLoading ? null : _handleAddGift,
